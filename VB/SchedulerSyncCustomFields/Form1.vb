...
Namespace SchedulerSyncCustomFields
	Partial Public Class Form1
		...
		Public Sub New()
            ...
            Dim row As DataSet1.EventsRow = dataSet11.Events.NewEventsRow()
		...
		Private Sub btnImport_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnImport.Click
			...
			CType(importSynchronizer, ISupportCalendarFolders).CalendarFolderName = cbOutlookCalendars.Text
		...
		Private Sub btnExport_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnExport.Click
			...
			CType(exportSynchronizer, ISupportCalendarFolders).CalendarFolderName = cbOutlookCalendars.Text
		...
		Private Sub schedulerControl1_InitAppointmentDisplayText(ByVal sender As Object, ByVal e As AppointmentDisplayTextEventArgs) Handles schedulerControl1.InitAppointmentDisplayText
			...
			If contactInfo Is Nothing Then
				e.Text = String.Format("{0} (Contact Info: {1})", e.ViewInfo.Appointment.Subject, ("N/A"))
			Else
				e.Text = String.Format("{0} (Contact Info: {1})", e.ViewInfo.Appointment.Subject, (contactInfo.ToString()))
			End If
		End Sub
	End Class
End Namespace